...
* NB: Waarom moeten we nu ineens eerst die nieuwe tekstvariabele aanmaken (met STRING)?.
...
* Run steeds een FREQUENCIES commando als je een nieuwe nominale/ordinale variabele hebt gemaakt,
*  om het resultaat te checken.
...
* Je kan hiervoor het menu gebruiken (File, save as...etc), maar zorg wel dat je het commando 'Paste'
*  en dan vanuit syntax runt.
