...
SORT CASES BY Pclass.
SPLIT FILE LAYERED BY Pclass.
...
COMPUTE jonger_dan_18 = (Age < 18).
FILTER BY jonger_dan_18.

FREQUENCIES Survived Pclass Sex.
MEANS Survived.

FILTER OFF.

* Ik zie 113 kinderen, waarvan 54% (61 kinderen) de ramp overleefde.
* 12 kinderen zaten in eerste klasse,  23 in tweede klasse en 78 in derde klasse.
* 51,3% van de kinderen was een jongen, dus er waren meer jongens dan meisjes aan boord.
* Het gemiddelde van Survived is 0.54. Dat is hetzelfde als 54%.
* Het gemiddelde van een dummy variabele is het percentage voor de waarde die 1 weergeeft.
* VB: jonger_dan_18 variabele is 1 als iemand jonger dan 18 is. MEANS jonger_dan_18 geeft dan
het percentage passagiers weer dat jonger dan 18 is.
