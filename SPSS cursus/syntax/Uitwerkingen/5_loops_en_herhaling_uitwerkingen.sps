...
COMPUTE VB1 = NUMBER(VBZS1, F2.0).

DO IF CHAR.INDEX(VBZS1, "10") > 0.
COMPUTE VB1 = 10.
ELSE IF CHAR.INDEX(VBZS1, "0") > 0.
COMPUTE VB1 = 0.
END IF.

RECODE VBZS1 ("Geen mening",
    "Keine Meinung",
    "No opinion",
    "Pas d’opinion",
    "sin opinion",
...
* Pas deze syntax dusdanig aan zodat je hem kan gebruiken om VBZS1 t/m VBZS10
...
DO REPEAT tekstvar = VBZS1 TO VBZS10 / 
                   numvar = VB1 TO VB10.
